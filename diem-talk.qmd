...
::: {.column width="55%"}
<img src="figures/sequoia-600b.png" alt="Sequoia 600 billion revenue gap chart" width="100%"/>
...
<img src="figures/sam-altman.jpg" alt="Sam Altman speaking at TED" width="100%"/>
...
::: {.column width="45%"}
<img src="figures/nvidia-h100.png" alt="NVIDIA H100 GPU" width="100%"/>
...
<img src="figures/garry-tan.jpg" alt="Garry Tan, CEO of Y Combinator" width="60%"/>
...
::: {.column width="45%"}
:::{style="margin-top: -30px; text-align: center;"}
<img src="figures/paul-graham.jpg" alt="Paul Graham, co-founder of Y Combinator" width="70%"/>
...
::: {.column width="45%"}
:::{style="margin-top: -30px; text-align: center;"}
<img src="figures/nyse-floor.jpg" alt="NYSE trading floor" width="100%"/>
...
::: {.column width="45%"}
<img src="figures/medallion-returns.jpeg" alt="Medallion Fund vs S&P 500 annual returns 1988-2021" width="100%"/>
